...
def youtube_search(id, max_results=500,order="date", token=None, location=None, location_radius=None):
...
def video_comments(video_id, max_results=500):
...
if __name__ == "__main__":
    youtube_scrape("UCo8h2TY_uBkAVUIc14m_KCA")